      ...
      <header className="border-b border-radio-border bg-radio-surface/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center gap-3">
          <div className="relative">
            ...
            <div className="relative w-8 h-8 rounded-lg bg-radio-accent flex items-center justify-center">
          ...
          {isLive && (
            <span className="inline-flex items-center gap-1.5 ml-2 px-2 py-0.5 rounded-full bg-red-500/20 border border-red-500/40 text-xs font-semibold text-red-400 uppercase tracking-wider">
